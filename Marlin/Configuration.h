...
#define STRING_CONFIG_H_AUTHOR "(Multi Media, Voxelab Aquila)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 43.4
  #define DEFAULT_bedKi 8.09
  #define DEFAULT_bedKd 155.5
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26, -2, 0 }
